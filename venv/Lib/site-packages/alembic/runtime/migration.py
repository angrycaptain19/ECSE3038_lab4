...
class RevisionStep(MigrationStep):
    ...
    def merge_branch_idents(self, heads):
        ...
        if other_heads:
            ancestors = {r.revision for r in self.revision_map._get_ancestor_nodes(
    ...
    def should_merge_branches(self, heads):
        ...
        return len(downrevs) > 1 and len(heads.intersection(downrevs)) > 1
    ...
    def should_unmerge_branches(self, heads):
        ...
        return self.revision.revision in heads and len(downrevs) > 1
