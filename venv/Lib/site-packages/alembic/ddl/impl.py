...
class DefaultImpl(with_metaclass(ImplMeta)):
    ...
    def __init__(
        ...
        if self.literal_binds and not self.as_sql:
    ...
    def _column_types_match(self, inspector_params, metadata_params):
        ...
        return any({inspector_all_terms, metadata_all_terms}.issubset(batch) or {
                inspector_params.token0,
                metadata_params.token0,
            }.issubset(batch) for batch in synonyms)
    ...
    def compare_type(self, inspector_column, metadata_column):
        ...
        if not self._column_types_match(inspector_params, metadata_params):
            return True
        return not self._column_args_match(inspector_params, metadata_params)
